                          ...
                          <>
                            <tr className="border-b border-gray-100 dark:border-white/5 bg-blue-100 dark:bg-blue-900/40">
                              <td colSpan={7} className="px-5 py-3">
                                <div className="grid gap-6" style={{ gridTemplateColumns: '1.2fr 2fr 1fr 0.6fr 1fr 1fr 1.2fr 1.4fr 1.2fr' }}>
                              ...
                              return (
                                ...
                                >
                                  <td colSpan={7} className="px-5 py-4">
                                    <div className="grid gap-6 text-sm" style={{ gridTemplateColumns: '1.2fr 2fr 1fr 0.6fr 1fr 1fr 1.2fr 1.4fr 1.2fr' }}>
